...
class SceneGS:
    ...
    def __init__(self, sh_degree: int, only_rgb: bool=False):
        ...
        self.gs_cls = torch.empty(0)    #semantics, shape:[6890, num_class]
    ...
    def create_from_pcd(self, pcd, spatial_lr_scale: float):
        ...
        #semantics
        gs_cls = np.zeros((self.get_xyz.shape[0], 8))
    ...
    def prune_points(self, mask):
        ...
        self.gs_cls = optimizable_tensors["semantics"]#semantic
    ...
    def densification_postfix(self, new_xyz, new_cls, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation):
        d = {"xyz": new_xyz,
            "semantics": new_cls,  
    ...
    def densify_and_split(self, grads, grad_threshold, scene_extent, N=2):
        ...
        new_cls = self.gs_cls[selected_pts_mask].repeat(N, 1)#semantic
        ...
        self.densification_postfix(new_xyz, new_cls, new_features_dc, new_features_rest, new_opacity, new_scaling, new_rotation)
    ...
    def densify_and_clone(self, grads, grad_threshold, scene_extent):
        ...
        new_cls = self.gs_cls[selected_pts_mask]#semantic
        ...
        self.densification_postfix(new_xyz, new_cls, new_features_dc, new_features_rest, new_opacities, new_scaling, new_rotation)
